...
/**
 * JNI bridge for the WSOLA time-stretch processor (libani_wsola).
 *
 * Kotlin contract: me.him188.ani.app.video.player.media.audio.WsolaProcessorNative.
...
Java_me_him188_ani_app_video_player_media_audio_WsolaProcessorNative_create(
...
Java_me_him188_ani_app_video_player_media_audio_WsolaProcessorNative_setSpeed(
...
extern "C" JNIEXPORT void JNICALL
Java_me_him188_ani_app_video_player_media_audio_WsolaProcessorNative_queueInput(
...
Java_me_him188_ani_app_video_player_media_audio_WsolaProcessorNative_drainOutput(
...
Java_me_him188_ani_app_video_player_media_audio_WsolaProcessorNative_getPendingInputFrames(
...
extern "C" JNIEXPORT void JNICALL
Java_me_him188_ani_app_video_player_media_audio_WsolaProcessorNative_flush(
    JNIEnv * /* env */, jclass /* clazz */, jlong handle)
{
    WsolaContext *ctx = fromHandle(handle);
    if (ctx == nullptr) {
...
extern "C" JNIEXPORT void JNICALL
Java_me_him188_ani_app_video_player_media_audio_WsolaProcessorNative_finishInput(
    JNIEnv * /* env */, jclass /* clazz */, jlong handle)
{
    WsolaContext *ctx = fromHandle(handle);
    if (ctx == nullptr) {
...
extern "C" JNIEXPORT void JNICALL
Java_me_him188_ani_app_video_player_media_audio_WsolaProcessorNative_release(
    JNIEnv * /* env */, jclass /* clazz */, jlong handle)
{
